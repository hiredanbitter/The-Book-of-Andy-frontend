...
| `002_semantic_search_function.sql` | Creates the `semantic_search` RPC function for pgvector cosine similarity search with episode/podcast metadata joins and pagination |
