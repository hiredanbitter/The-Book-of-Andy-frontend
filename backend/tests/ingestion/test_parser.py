...
#     print(f"Chunk {i}: start={chunk.start_timestamp}, end={chunk.end_timestamp}, speaker={chunk.speaker_label}")
...
# [TranscriptLine(speaker_label='SPEAKER_01', start_timestamp='0:00:00', end_timestamp='0:00:15', text='This one is valid.'), TranscriptLine(speaker_label='SPEAKER_01', start_timestamp='0:00:16', end_timestamp='0:00:30', text='Hello, welcome to the show.'), TranscriptLine(speaker_label='SPEAKER_02', start_timestamp='0:00:31', end_timestamp='0:00:45', text='Thanks for having me.')]
...
#Then query Supabase directly (in the dashboard or via the client) to confirm rows exist in `transcript_chunks` with non-null `embedding`, correct `start_timestamp`, `end_timestamp`, `speaker`, and sequential `chunk_index` values.
...
# [TranscriptLine(speaker_label='SPEAKER_01', start_timestamp='0:00:16', end_timestamp='0:00:30', text='Hello, welcome to the show.'), TranscriptLine(speaker_label='SPEAKER_02', start_timestamp='0:00:31', end_timestamp='0:00:45', text='Thanks for having me.')]
